...
class SubCategoryPage extends GenericPage {
  const SubCategoryPage({super.key, required super.title});

  @override
  Widget? build(BuildContext context) {
    var factory = ServiceLocator.instance.get<ISubCategoryFactory>();
